import setuptools
import logride._info as package_info
...
setuptools.setup(
    ...
    url='https://github.com/nwithan8/logride-python',  # Provide either the link to your github or to your website
    download_url=f'https://github.com/nwithan8/logride-python/archive/{package_info.__version__}.tar.gz',
